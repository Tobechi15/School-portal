      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="javascript:;">General Settings</a>
          </div>
                      ...
                      <ul class="nav nav-tabs" data-tabs="tabs">
                        ...
                        <li class="nav-item">
                          <a class="nav-link" href="#security" data-toggle="tab">
                            <i class="material-icons">security</i>SECURITY SETTINGS
                            <div class="ripple-container"></div>
                          </a>
                        </li>
                        <li class="nav-item">
                          <a class="nav-link" href="#notification" data-toggle="tab">
                            <i class="material-icons">notifications</i>NOTIFICATION SETTINGS
                            <div class="ripple-container"></div>
                          </a>
                        </li>
                      </ul>
                              ...
                              <div class="row">
                                <div class="col-md-4 col-12">
                                  <div class="form-group">
                                    <h5 class="bmd-label-floating">Account Name</h5>
                                  </div>
                                </div>
                                <div class="col-md-4 col-12">
                                  <div class="form-group">
                                    <input type="text" class="form-control" value="Franklin John">
                                  </div>
                                </div>
                              </div>
                              <div class="row">
                                <div class="col-md-4 col-12">
                                  <div class="form-group">
                                    <h5 class="bmd-label-floating">Resdential Address</h5>
                                  </div>
                                </div>
                                <div class="col-md-6 col-12">
                                  <div class="form-group">
                                    <input type="text" class="form-control" value="No 5 Amadi Lane Oyigbo">
                                  </div>
                                </div>
                              </div>
                              <div class="row">
                                <div class="col-md-4 col-12">
                                  <div class="form-group">
                                    <h5 class="bmd-label-floating">State Of Origin</h5>
                                  </div>
                                </div>
                                <div class="col-md-4 col-12">
                                  <div class="form-group">
                        ...
                        <div class="card-body">
                            <form>
                              <div class="row">
                                <div class="col-md-4 col-12">
                                  <div class="form-group">
                                    <h5 class="bmd-label-floating">Password</h5>
                                  </div>
                                </div>
                                <div class="col-md-4 col-12">
                                  <div class="form-group">
                                    <input type="password" class="form-control"  id="inactive-input" value="12345678">
                                  </div>
                                </div>
                              </div>
                              <div class="row">
                                <div class="col-md-4 col-12">
                                  <div class="form-group">
                                    <h5 class="bmd-label-floating">New Password</h5>
                                  </div>
                                </div>
                                <div class="col-md-4 col-12">
                                  <div class="form-group">
                              ...
                              <div class="row">
                                <div class="col-md-4 col-12">
                                  <div class="form-group">
                                    <h5 class="bmd-label-floating">Confirm New Password</h5>
                                  </div>
                                </div>
                                <div class="col-md-4 col-12">
                                  <div class="form-group">
                      ...
                      <table class="table">
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td class="td-actions text-right">
                              <button type="button" rel="tooltip" data-toggle="modal" data-target="#uploadmedia" title="Edit Task" class="btn btn-primary btn-link btn-sm">
                                <i class="material-icons">edit</i>
                              </button>
                              <button type="button" rel="tooltip" title="Remove" class="btn btn-danger btn-link btn-sm">
                                <i class="material-icons">close</i>
