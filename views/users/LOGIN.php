            ...
            <div class="col-md-5"  id="login">
              <div class="card">
                <div class="card-header">
                  <h3 class="card-title text-center text-primary">LOGIN <span class="material-icons">school</span></h3>
                </div>
              </div>
              <div class="card"><!-- 
                <div class="card-header">
                ...
                <!-- BASIC DETAILS FORM -->
                  <div class="card-body">
                    <form method="post" action="<?php $_SERVER['PHP_SELF']; ?>">
                      ...
                      <input type="submit" name="submit" value="Sign In" class="btn btn-primary col-12">
    ...
    $(document).ready(function () {
      ...
      cooperate.onclick = () => {
        if (cooperate.checked == true) {
          ...
          add.previousElementSibling.previousElementSibling.classList = 'row show-clicked'
        };
      };
