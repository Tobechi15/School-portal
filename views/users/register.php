      ...
      <div class="content">
        ...
        <?php Messages::display(); ?>
          <div class="row">
            ...
            <div class="col-md-12">
              <div class="card-primary card card-stats  card2">
                <div class="card-header card-header-primary card-header-icon">
                  
                  <div class="card-icon card-icon2">
                    <i class="material-icons">group</i>
                  </div>
                  <h3 class="card-title card-title2">Users
                  </h3>
                </div>
              </div>
            </div>
              ...
              <div class="card">
                  ...
                  <div class="nav-tabs-navigation">
                    <div class="nav-tabs-wrapper">
                      <ul class="nav nav-tabs" data-tabs="tabs">
                        <li class="nav-item">
                          <a class="nav-link active" href="#add_user" data-toggle="tab">
                            <i class="material-icons">person_add</i>Add User
                            <div class="ripple-container"></div>
                          </a>
                        </li>
                        <li class="nav-item">
                          <a class="nav-link" href="#view_users" data-toggle="tab">
                ...
                <div class="card-body">
                  <div class="tab-content">
                        ...
                        <div class="card-body">
                          <form method="post" action="<?php $_SERVER['PHP_SELF']; ?>">
                              ...
                              <div class="col-md-6 col-12">
                                <div class="form-group">
                                  <select name="select" id="select" class="form-control">
                                    <option value="0" class="bmd-label-floating">User Type</option>
                                    <option value="1">Front Desk</option>
                                    <option value="2">Restaurant Attendant</option>
                                    <option value="2">Bar Man</option>
                            ...
                            <div class="col-12">
                              ...
                              <div class="row">
                                  <div class="col-md-6">
                                    <label for="">USER ACCESS</label><br>
                                    <input type="checkbox" id="individual" name="guest" value="individual">
                                    <label for="individual">Room Booking</label><br>
                                    <input type="checkbox" id="cooperate" name="guest" value="cooperate">
                                    <label for="cooperate">Restaurant Booking</label><br>
                                    <input type="checkbox" id="cooperate" name="guest" value="cooperate">
                                    <label for="cooperate">Hall Booking</label><br>
                                    <input type="checkbox" id="individual" name="guest" value="individual">
                                    <label for="individual">Swimming Pool</label><br>
                                    <input type="checkbox" id="cooperate" name="guest" value="cooperate">
                                    <label for="cooperate">Mescellenious</label><br>
                                  </div>
                                  <div class="col-md-6">
                                    <label for="">ADMINISTRATIVE ACCESS</label><br>
                                    <input type="checkbox" id="individual" name="guest" value="individual">
                                    <label for="individual">Users</label><br>
                                    <input type="checkbox" id="cooperate" name="guest" value="cooperate">
                                    <label for="cooperate">Facilities</label><br>
                                    <input type="checkbox" id="cooperate" name="guest" value="cooperate">
                                    <label for="cooperate">Coupons</label><br>
                                    <input type="checkbox" id="individual" name="guest" value="individual">
                                    <label for="individual">VAT</label><br>
                                    <input type="checkbox" id="cooperate" name="guest" value="cooperate">
                                    <label for="cooperate">Financial Summary</label><br>
                                  </div>
                                </div>
                              </div>
                            </div>
                            ...
                            <div class="col-md-6 col-12">
                              <div class="form-group">
                                ...
                                <input type="password" name="pass_test" class="form-control">
                              </div>
                            </div>
                          </div>
                    ...
                    <div class="tab-pane" id="view_users">
                      <table class="table">
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td>Marthin Luther</td>
                            <td>Receptionist</td>
                            <td class="td-actions text-right">
                              <button type="button" rel="tooltip" title="Edit User" class="btn btn-primary btn-link btn-sm">
                                <i class="material-icons">edit</i>
                              </button>
                              <button type="button" rel="tooltip" title="Delete User" class="btn btn-danger btn-link btn-sm">
