        ...
        <ul class="nav">
          ...
          <li class="nav-item dropdwn">
            ...
            <ul class="unstyled-list">
              <li class="nav-item "><a class="nav-link" href="<?php echo ADMIN_ROOT_URL?>academic"><p>Academic</p></a></li>
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="javascript:;">School Admin Management Dasoard</a>
          </div>
          ...
          <div class="col-md-12">
               <div class="card card-stats">
                 <div class="card-header card-header-danger card-header-icon">
                   ...
                   <p class="card-category">Staff Name</p>
                   <h3 class="card-title"><?php echo $_SESSION['admin_user_data']['name']?> 
                   </h3>
                 </div>
                 <div class="card-footer">
                   <div class="stats">
                     <i class="material-icons text-danger"></i>
                     <a href="javascript:;" data-toggle="modal" data-target="#addDrink">Student ID: <?php echo $_SESSION['admin_user_data']['staff_Id']?></a>
                   </div>
                 </div>
               </div>
             </div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
              <div class="card card-stats">
                <div class="card-header card-header-success card-header-icon">
                  ...
                  <?php
                            $database->query("SELECT COUNT(*) FROM course");
                            $rows = $database->resultset();
                        ?>
