...
<body class="">
  <div class="wrapper ">
        ...
        <ul class="nav">
          ...
          <li class="nav-item dropdwn active">
            ...
            <ul class="unstyled-list">
              <li class="nav-item "><a class="nav-link" href="<?php echo ROOT_URL?>portal\academic">
                  <p>Academic</p>
                </a></li>
              <li class="nav-item "><a class="nav-link" href="<?php echo ROOT_URL?>portal\courses">
                  <p>Courses</p>
                </a></li>
              <li class="nav-item "><a class="nav-link" href="<?php echo ROOT_URL?>portal\finance">
                  <p>Finances</p>
                </a></li>
              <li class="nav-item "><a class="nav-link" href="<?php echo ROOT_URL?>portal\travel">
                  <p>Travel</p>
                </a></li>
            </ul>
          </li>
    ...
    <div class="main-panel">
            ...
            <div class="col-md-12">
              <div class="card card-stats">
                <div class="card-header card-header-danger card-header-icon">
                  ...
                  ?>
                  <p class="card-category">Number of Reg Courses</p>
                  <h3 class="card-title">
                ...
                <div class="card-footer">
                  <div class="stats">
                    ...
                    <a href="#" data-toggle="modal" data-target="#addFood" class="btn btn-primary pull-right">register
                      course</a>
                    <a href="#" data-toggle="modal" data-target="#receipt" class="btn btn-primary pull-right">Print
                      course form</a>
                  </div>
                </div>
              </div>
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td class="td-actions text-right">
                          <button type="button" rel="tooltip" title="More Details" data-toggle="" data-target=""
      ...
      <?php
              $database->query("SELECT * FROM course ");
              $rows = $database->resultset();
            ?>
      ...
      <!-- ------ADD FOOD MODAL -->
      <div class="modal fade" id="addFood" tabindex="-1" role="dialog" aria-labelledby="mediumModalLabel"
        aria-hidden="true">
              ...
              <div class="card-body">
                <form method="post" action="<?php $_SERVER['PHP_SELF']; ?>">
                  <div class="row">
                    <div class="col-12">
                      <div class="form-group">
                        ...
                        <select name="course" id="select" class="form-control">
                          ...
                          <option
                            value="data:<?php echo $item['course_title'] ?>,<?php echo $item['course_code'] ?>,<?php echo $item['course_unit'] ?>">
                            <?php echo $item['course_title'] ?>
                          </option>
                          <?php endforeach; ?>
                        </select>
                    ...
                    <input type="hidden" name="id" value="<?php echo $_SESSION['user_data']['studentId'] ?>">
                  </div>
          ...
          <div class="modal-content">
            <div class="modal-body">
              <div class="card">
                <div class="card-body">
                  <hr>
                  <div class="summary-body" id="printableArea">
                    <div class="col-md-12 text-center">
                      <h2 class="modal-title" id="mediumModalLabel">Damola University</h2>
                      <p>First smester Course Form</p>
                    </div>
                    <div class="row">
                      <div class="col-md-6">
                        <table class="top-table">
                          <tr>
                            ...
                            <td class="text-right"><strong>
                                <?php echo $_SESSION['user_data']['suname'] ?>
                                <?php echo $_SESSION['user_data']['firname'] ?>
                              </strong></td>
                          </tr>
                          <tr>
                            <td>stu ID</td>
                            <td class="text-right"><strong>
                                <?php echo $_SESSION['user_data']['studentId'] ?>
                              </strong></td>
                          </tr>
                          <tr>
                        </table>
                      ...
                      <div class="col-md-6">
                        <table class="top-table col-12">
                          <tr>
                            <td>Session</td>
                            <td class="text-right"><strong>2023/2024</strong></td>
                          </tr>
                          <tr>
                            <td>Semester</td>
                            <td class="text-right"><strong>First</strong></td>
                          </tr>
                          <tr>
                            <td>Print Date:</td>
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        <table border=1 class="middle-table col-12">
                          <tr>
                            <th>S/n</th>
                            <th>Course title</th>
                      ...
                      <div class="col-12">
                        <table class="bottom-table float-right col-md-6">
                          <tr>
                            ...
                            <td class="text-right"><span>___________________________</span></td>
                          </tr>
                          <tr>
                            <td>HOD</td>
                            <td class="text-right"><span>___________________________</span></td>
                  ...
                  <div class="card-footer2">
                    <p>I/We agree that my/our liability for this bill is not walved and agree to be held
                      personally/jointly liable in the event that the sponsoring authority fails to pay for any part or
