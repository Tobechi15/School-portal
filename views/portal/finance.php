             ...
             <div class="col-md-12">
               <div class="card card-stats">
                 <div class="card-header card-header-danger card-header-icon">
                   ...
                   <p class="card-category">busary</p>
                   <h3 class="card-title"><span>&#8358</span>0.00
                   </h3>
                 </div>
                 <div class="card-footer">
                   <div class="stats">
                     <i class="material-icons text-danger"></i>
                     <a href="javascript:;" data-toggle="modal" data-target="#addDrink">Make Payment</a>
                   </div>
                 </div>
               </div>
             </div>
                     ...
                     <?php foreach ($viewmodel as $item) : ?>
                        <?php if ($item['stu_id'] == $_SESSION['user_data']['studentId']) : ?>
                          <tr>
                            ...
                            <td><?php echo $item['trans_type']; ?></td>
