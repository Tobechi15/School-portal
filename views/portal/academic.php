      ...
      <div class="content">
        <div class="container-fluid">
          <div class="row">
              ...
              <div class="card card-stats">
                ...
                <div class="card-footer">
                  <div class="stats">
                    ...
                    <a href="#" data-toggle="modal" data-target="#receipt" class="btn btn-primary pull-right">Print Result</a>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="col-md-12" id="yourDivId">
              <div class="card">
                  ...
                  <div class="row">
                    ...
                    <div class="col-12">
                      <div class="form-group">
                        ...
                        <input type="number" name="room_no" class="form-control" min="0">
                      </div>
                    </div>
                    <div class="col-md-6 col-12">
                      <div class="form-group">
                        <label class="bmd-label-floating">Room Price</label>
                        <input type="text" name="room_price" class="form-control" value="&#8358">
                      </div>
                    </div>
                  </div>
            ...
            <div class="modal-body">
              <div class="card">
                <div class="card-body">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <table class="top-table">
                          <tr>
                            <td>Name:</td>
                            <td class="text-right"><strong><?php echo $_SESSION['user_data']['suname'] ?> <?php echo $_SESSION['user_data']['firname'] ?></strong></td>
                          </tr>
                          <tr>
                            <td>stu ID</td>
                            <td class="text-right"><strong><?php echo $_SESSION['user_data']['studentId'] ?></strong></td>
                          </tr>
                          <tr>
                            <td>CGPA</td>
                            <td class="text-right"><strong>4.0</strong></td>
                          </tr>
                  ...
                  <button type="submit" onclick="print()" class="btn btn-primary pull-right col-12">Print</button>
                  <div class="clearfix"></div>
                </div>
              </div>
            </div>
